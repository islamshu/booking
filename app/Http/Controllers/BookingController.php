...
class BookingController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $booking->save();
        if(isset($request->hotel)){
            Hotel::where('booking_id',$id)->delete();
            foreach($request->hotel as $hotel){
                if($hotel == null){
                    continue;
                }
        ...
        if(isset($request->note)){
            BookingNote::where('booking_id',$id)->delete();
        ...
        if(isset($request->detiles)){
            BookingDetiels::where('booking_id',$id)->delete();
        ...
        if(isset($request->arraive)){
            BookingArraive::where('booking_id',$id)->delete();
